...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            lblAvgLocationPrice.Text = string.Format("{0:F2} ₺", db.Location.Average(x => x.Price)); 
            ...
            var guideIdByNameAysegulCinar = db.Guide.Where(x => x.GuideName == "Ali" && x.GuideSurname == "Yıldız").Select(y => y.GuideId).FirstOrDefault();
